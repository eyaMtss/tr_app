...
export class SocieteDeRemorquageComponent implements OnInit {
  ...
  constructor(private camionService: CamionService, config: NgbModalConfig, private modalService: NgbModal, private _formBuilder: FormBuilder, private personelService: PersonnelService) {

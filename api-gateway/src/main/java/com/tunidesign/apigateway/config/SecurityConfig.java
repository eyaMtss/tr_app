...
//                        .pathMatchers(HttpMethod.GET, "/Users/CompanyEmployees/**").hasRole("COMPANY_ADMIN")
    ...
    public ClientRegistration keycloakClientRegistration() {
        return ClientRegistration.withRegistrationId("keycloak")
                ...
                .clientSecret("XrIqm5TRk6TqGZT5IISCMa7xIsilq2Nk")
                .authorizationGrantType(AuthorizationGrantType.AUTHORIZATION_CODE)
                .redirectUri("{baseUrl}/login/oauth2/code/{registrationId}")
                .scope("openid", "profile", "email", "roles")  //
                .issuerUri("http://localhost:8080/realms/tunidesign")
                .authorizationUri("http://localhost:8080/realms/tunidesign/protocol/openid-connect/auth")
                .tokenUri("http://localhost:8080/realms/tunidesign/protocol/openid-connect/token")
                .userInfoUri("http://localhost:8080/realms/tunidesign/protocol/openid-connect/userinfo")
                .jwkSetUri("http://localhost:8080/realms/tunidesign/protocol/openid-connect/certs")
